...
<style type="text/css">
body { background: url('<?php echo SIGNALS_CSMM_URL; ?>/content/img/data/elegant.png'); }
<?php
					...
					<div class="row">
						<div class="small-12 medium-8 medium-offset-2 columns">
							...
							<form role="form" method="POST">
								...
								<button type="submit" class="button small radius success"><?php _e('Subscribe Me', 'signals'); ?></button>
							</form>
						</div>
					</div>
